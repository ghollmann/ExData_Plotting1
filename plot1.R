...
# The results of this script is to produce a histogram of household global minute-averaged
# active power (in kilowatts) for the time period of February 1, 2007 and February 2, 2007.
# This histogram will be save to a file named plot1.png. In order to read in the entire file
...
hist(HPConsumptionSub$Global_active_power, col="red" ,main="Global Active Power",
     xlab="Global Active Power (kilowatts)", ylab="Frequency", freq=TRUE, breaks=12, ylim=c(0,1200),
     xlim=c(0,6))
